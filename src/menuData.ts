  ...
  'Їжа': [
    {
      ...
      items: [
        { 
          ...
          description: 'Бріош, авокадо, лосось слабосолений, яйця пашот, соус голландез, рукола, вершкове масло, зелена цибуля, parkmezan',
          weight: '300 г', 
          price: '325 грн' 
        },
        { 
        ...
        { 
          name: 'Авокадо тости', 
          description: 'Авокадо (50 г), тости (2 шт), крем-сир філадельфія, рукола, яйце пашот (1 шт), лосось (100 г), чері', 
          price: '270 грн' 
        },
      ]
    },
    {
      ...
      items: [
        ...
        { 
          ...
          description: 'Кабачок (50 г), баклажан (50 г), помідор (50 г), перець (50 г), гриби шампіньйони (50 г), вирізка телятини (100 г), соус барбекю (50 г), кетчуп + ерош пішта',
          weight: '300 г', 
          price: '280 грн' 
        },
      ]
    },
    {
      ...
      items: [
        ...
        { 
          name: 'Картопля креольська', 
          description: 'Кріп, часник',
          weight: '200 г', 
          price: '100 грн' 
        },
        { 
    ...
    },
    {
      ...
      items: [
        { 
          name: 'Шашлички курячі', 
          description: 'Куряче філе (300 г сирого), кабачок (50 г), баклажан (50 г), гриби (50 г), перець (50 г), кетчуп та майонез',
          weight: '350 г', 
          price: '250 грн' 
        },
        { 
          name: 'Шашлики свинина', 
          description: 'Свинина (300 г сирого), кабачок (50 г), баклажан (50 г), гриби (50 г), перець (50 г), соус барбекю, декор з руколи та чері',
          weight: '350 г', 
          price: '270 грн' 
        },
        { 
        ...
        { 
          name: 'Крила медово-гірчичні', 
          description: 'Курячі крила (300 г сирого), соєвий соус (100 г), мед (50 г), ерош пішта',
          price: '210 грн' 
        },
        { 
          name: 'Сердечка фрі', 
          description: 'Курячі сердечка (300 г сирого), яйця (2 шт), борошно, сухарі, соус кетчуп, медово-гірчичний соус',
          price: '250 грн' 
        },
        { 
          name: 'Сердечка в соєвому соусі', 
          description: 'Курячі сердечка (300 г сирого), соєвий соус, мед, ерош пішта',
          price: '180 грн' 
        },
      ]
    },
      ...
      items: [
        {
          ...
          description: 'Бекон (100 г), часник, вершки, тонкі спагеті, пармезан, яйця',
          price: '200 грн'
        },
        {
          name: 'Фетучіні з куркою',
          description: 'Паста фетучіні, курка (200 г сирого), томати чері, пармезан (50 г), вершки (100 г), мікрогрін',
          price: '250 грн'
        },
        {
          name: 'Паста з лососем',
          description: 'Лосось (150 г), вершкове масло, вершки (100 г), лимонний сік, пармезан (50 г), томати чері, мікрогрін',
          price: '270 грн'
        }
      ]
    },
    {
      ...
      items: [
        { 
          name: 'Сирна дошка', 
          description: 'Сир брі, дор блю, пармезан, королівський, сир з горішками (по 50 г), горіхи (30 г), мед, м’ята, ягоди, виноград (100 г)',
          weight: '380 г', 
          price: '565 грн' 
        },
        { 
          name: 'М’ясна тарілка', 
          description: 'Хамон, чорізо, прошуто, салямі суха, кабаноси (по 50 г), оливки, чері, рукола (100 г)',
          weight: '350 г', 
          price: '495 грн' 
        },
        { 
