  ...
  return (
    <header style={{
      ...
      <div className="container" style={{
        ...
        {/* Десктопне меню (ховається через CSS на мобайлі) */}
        ...
        {/* Кнопка Гамбургер (тільки для мобілок) */}
        <button className="hamburger" onClick={toggleMenu} style={{
          ...
          <span style={{ ...lineStyle, width: '25px', transform: isMenuOpen ? 'rotate(45deg) translate(5px, 5px)' : 'none' }}></span>
          <span style={{ ...lineStyle, width: '25px', opacity: isMenuOpen ? 0 : 1 }}></span>
          <span style={{ ...lineStyle, width: '25px', transform: isMenuOpen ? 'rotate(-45deg) translate(4px, -5px)' : 'none' }}></span>
        </button>
          ...
          <ul style={{ display: 'flex', flexDirection: 'column', gap: '40px', textAlign: 'center', listStyle: 'none', padding: 0 }}>
            ...
            <li>
              <a 
                ...
                style={{ ...mobileNavLinkStyle, color: '#D4AF37', fontSize: '1.4rem' }}
              >
                INSTAGRAM
              </a>
            </li>
